...
while ($stmt->fetch()) {
	if ($inaddress) {
		$input .= '
					<tr>
                        <td><a href="./index.php?engine=blockexplorer&address=' . $inaddress .'" class="internal">' . $inaddress .'</a></td>
                        <td style="text-align: right;">' . number_format($invalue, 8, '.', ',') .' ZET</td>
                    </tr>';
	} else {
		$input .= '
					<tr>
...
while ($stmt->fetch()) {
	$output .= '
				<tr>
                    <td><a href="./index.php?engine=blockexplorer&address=' . $outaddress .'" class="internal">' . $outaddress .'</a></td>
                    <td style="text-align: right;">' . number_format($outvalue, 8, '.', ',') .' ZET</td>
                </tr>';
...
<div id="main-region"><div><div id="transaction-details">
    ...
    <div class="large-12 columns">
        <ul class="breadcrumbs">
            <li><a class="internal" href="./index.php?engine=blockexplorer">blockchain</a></li>
            <li class="unavailable"><a href="./index.php?engine=blockexplorer" class="internal">Transactions</a></li>
            <li class="current"><a href="./index.php?engine=blockexplorer&tx=<?php echo $txhash; ?>" class="internal">#<?php echo $txhash; ?></a></li>
        </ul>
            ...
            <tbody>
                ...
                <tr>
					<td class="tableRowLabel">In Blocks</td><td class="tableRowValue hashSize">
						<a href="./index.php?engine=blockexplorer&hash=<?php echo $block; ?>" class="internal"><?php echo $block; ?></a><br />
					</td>
                </tr>
                <tr><td class="tableRowLabel">Total Input</td><td class="tableRowValue"><?php echo number_format($totalinput, 8, '.', ','); ?> ZET</td></tr>
                <tr><td class="tableRowLabel">Total Output</td><td class="tableRowValue"><?php echo number_format($totaloutput, 8, '.', ','); ?> ZET</td></tr>
<?php if (!$inaddress) { ?>
				<tr><td class="tableRowLabel">Staff Salary</td><td class="tableRowValue"><?php echo number_format($totalsalary, 8, '.', ','); ?> ZET</td></tr>
<?php } ?>
                <tr><td class="tableRowLabel">Block Fees</td><td class="tableRowValue"><?php echo number_format($totalfees, 8, '.', ','); ?> ZET</td></tr>
            </tbody>
        </table>
