...
while ($stmt->fetch()) {
	...
	$txrows .= '
		<tr>
			<td class="transactionHash"><a href="./index.php?engine=blockexplorer&tx=' . $txhash . '" class="internal transactionLink">' . $txhash . '</a></td>
			...
			<td class="transactedAmount hide-for-small">' . number_format($txoutvalue, 8, '.', ',') . ' ZET</td>
		</tr>';	
}
...
<div id="main-region"><div><div id="block">
    ...
    <div class="large-12 columns">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="./index.php?engine=blockexplorer&blockid=<?php echo $height; ?>" class="internal">Block #<?php echo $height; ?></a></li>
        </ul>
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td class="tableRowValue"><a href="./index.php?engine=blockexplorer&hash=<?php echo $previousblockhash; ?>" class="internal"><?php echo $previousblockhash; ?></a></td>
            </tr>
            <tr>
                <td class="tableRowLabel">Next Block:</td>
                <td class="tableRowValue"><a href="./index.php?engine=blockexplorer&hash=<?php echo $nextblockhash; ?>" class="internal"><?php echo $nextblockhash; ?></a></td>
            </tr>            
            <tr>
            ...
            <tr>
                ...
                <td class="tableRowValue"><?php echo number_format($tvalue, 8, '.', ','); ?> ZET</td>
            </tr>			
            <tr>
                <td class="tableRowLabel">Total Fees:</td>
                <td class="tableRowValue"><?php echo number_format($tfee, 8, '.', ','); ?> ZET</td>
            </tr>
            <tr>
                <td class="tableRowLabel">Block Reward</td>
                <td class="tableRowValue"><?php echo number_format($reward, 8, '.', ','); ?> ZET</td>
            </tr>
        </tbody></table>
    </div>
</div>
