...
<td class="blocksHash"><a href="./index.php?engine=blockexplorer&hash=' . $hash . '" class="internal transactionLink">' . $hash . '</a></td>
...
<div id="main-region"><div><div id="blocks-list">
    ...
    <div class="large-12 columns">
        <ul class="breadcrumbs">
            <li><a href="./" class="internal">Home</a></li>
            <li class="current">blockchain</li>
            <li class="current"><a href="./index.php?engine=blockexplorer" class="internal">Blocks</a></li>
        </ul>
    </div>
</div>
<div class="row">
